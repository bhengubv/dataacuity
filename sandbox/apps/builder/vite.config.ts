...
// Vercel preset disabled for Docker deployment
...
export default defineConfig(({ mode }) => {
  ...
  return {
    plugins: [
      remix({
        // Vercel preset removed for Docker deployment
        future: {
    ...
    server: {
      ...
      host: "0.0.0.0",
      allowedHosts: ["sandbox.dataacuity.co.za", "dataacuity.co.za", "localhost", "0.0.0.0"],
      // Needed for SSL
      proxy: {},

      // https disabled for Docker deployment
      cors: ((
        req: IncomingMessage,
